...
/**
 * PHPMailer - PHP SMTP email transport Tool
...
class SMTP {
  ...
  /**
   * Initialize the Tool so that the Data is in a known state.
   * @access public
   * @return SMTP
   */
  ...
  /**
   * Closes the socket and cleans up the state of the Tool.
  ...
  /**
   * This is an optional command for SMTP that this Tool does not
   * support. This method is here to make the RFC821 Definition
   * complete for this Tool and __may__ be implimented in the future
   *
