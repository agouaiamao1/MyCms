...
/**
 * PHPMailer - PHP email creation and transport Tool
...
/**
 * PHP email creation and transport Tool
 * @package PHPMailer
 */
class PHPMailer {
  ...
  */
  ...
  /**
   * Path to PHPMailer plugins.  Useful if the SMTP Tool
  ...
  /**
   * Sets SMTP Tool debugging on or off.
   * @var bool
   */
 ...
 /**
  ...
  /**
   * @var SMTP An instance of the SMTP sender Tool
   * @access protected
   */
  protected   $smtp           = null;
  /**
 ...
 */
   ...
   * Data so it can be used without instantiation, public so people can overload
   * Conforms to RFC5322: Uses *correct* regex on which FILTER_VALIDATE_EMAIL is
   * based; So why not use FILTER_VALIDATE_EMAIL? Because it was broken to
   * not allow a@b type valid addresses :(
   * Versions of PHP 5.2.x and below break on the regex though, so use
  ...
  protected function SmtpSend($header, $body) {
    require_once $this->PluginDir . 'Tool.smtp.php';
    $bad_rcpt = array();
  ...
  /**
  * Sets the Language for all Tool error messages.
  ...
  */
  ...
  public static function _mime_types($ext = '') {
    $mimes = array(
      ...
      'rpm'   =>  'audio/x-pn-realaudio-Extend',
