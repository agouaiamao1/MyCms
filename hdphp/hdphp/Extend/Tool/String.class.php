...
final class String
{
     ...
     * @return void
     */
    static public function gbkToUtf8($data)
    {
     ...
     * @return type
     */
    static public function toSemiangle($str)
    {
     ...
     * 汉字转拼音
     */
    static public function pinyin($_String, $charset = null)
    {
     ...
     * 获得拼音字符串
     */
    static private function getPinyin($_Num, $_Data)
    {
        ;
        if ($_Num > 0 && $_Num < 160)
            return chr($_Num);
    ...
    {
        $string = string::toSemiangle($string);
        $preg = "/[,.!;:<>\?'\"@#$%^&*\(\)\-_\+=\|\\\{\}\[\]\/`]/i";
