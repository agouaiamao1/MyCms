...
$db->exe("CREATE TABLE `".$db_prefix."category`".$db_prefix." (
  `".$db_prefix."cid`".$db_prefix." smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `".$db_prefix."keywords`".$db_prefix." char(100) NOT NULL DEFAULT '',
  `".$db_prefix."description`".$db_prefix." char(100) NOT NULL DEFAULT '',
  `".$db_prefix."face_thumb`".$db_prefix." char(100) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='网站配置'");
